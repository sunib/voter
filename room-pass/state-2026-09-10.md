...
Companion documents: [login-explained.md](login-explained.md) for why the design
is what it is, [advised_architecture.md](advised_architecture.md) and
[implementation_plan.md](implementation_plan.md) for the older plan — **both now
lag this document** (see [Documents that need reconciling](#documents-that-need-reconciling)).
...
## Documents that need reconciling
